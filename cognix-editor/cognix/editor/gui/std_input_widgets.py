...
class StdInputWidgetBase(NodeInputWidget):
    ...
    def on_widget_val_changed(self, val):
        """
...
class Builder:
    ...
    @staticmethod
    def evaled_line_edit(init=None, size='m', descr: str = '', resizing: bool = True, val_type: type = None):
        """
        ...
        class StdInpWidget_EvaledLineEdit(StdInputWidgetBase, QLineEdit):
            ...
            def val(self):
                try:
                    return val_type(eval(self.text()))
                except:
    ...
    @staticmethod
    def str_line_edit(init: str = '', size='m', descr: str = '', resizing: bool = True, val_type: type = None):
        """
        Creates a line edit input widget which evaluates its input.
        :param init: the initial value shown in the widget
        :param descr: the description of the input
    ...
    @staticmethod
    def int_spinbox(init: int = 0, range: tuple[int, int] = (0, 99), descr: str = ''):
        """
    ...
    @staticmethod
    def int_slider(init: int = 0, range: tuple[int, int] = (0, 10), descr: str = ''):
        """
    ...
    @staticmethod
    def bool_checkbox(init: bool = False, descr: str = ''):
        """
